...
def get_training_plan(runner):
    ...
    return """[
    {"date": "2024-08-02", "total_miles": 6, "run_details": "Easy run to build base", "run_type": "Easy Run"},
    {"date": "2024-08-03", "total_miles": 8, "run_details": "Tempo run at a sustained pace", "run_type": "Tempo Run"},
    {"date": "2024-08-04", "total_miles": 10, "run_details": "Easy run with strides", "run_type": "Easy Run"},
    {"date": "2024-08-05", "total_miles": 12, "run_details": "Hills training, repeat hill 4 times", "run_type": "Hills"},
    {"date": "2024-08-06", "total_miles": 4, "run_details": "Recovery run", "run_type": "Easy Run"},
    {"date": "2024-08-08", "total_miles": 14, "run_details": "Long run with a steady pace", "run_type": "Long Run"},
    {"date": "2024-08-09", "total_miles": 0, "run_details": "Rest day", "run_type": "Rest Day"},
    {"date": "2024-08-10", "total_miles": 7, "run_details": "Easy run to recover", "run_type": "Easy Run"},
    {"date": "2024-08-11", "total_miles": 8, "run_details": "Intervals: 5x1000m with rest", "run_type": "Intervals"},
    {"date": "2024-08-12", "total_miles": 10, "run_details": "Easy run with a few pickups", "run_type": "Easy Run"},
    {"date": "2024-08-13", "total_miles": 12, "run_details": "Race pace running for 4 miles", "run_type": "Race Pace"},
    {"date": "2024-08-14", "total_miles": 4, "run_details": "Recovery run", "run_type": "Easy Run"},
    {"date": "2024-08-15", "total_miles": 16, "run_details": "Long run with some faster sections", "run_type": "Long Run"},
    {"date": "2024-08-16", "total_miles": 0, "run_details": "Rest day", "run_type": "Rest Day"},
    {"date": "2024-08-17", "total_miles": 7, "run_details": "Easy run with stretches", "run_type": "Easy Run"},
    {"date": "2024-08-18", "total_miles": 8, "run_details": "Tempo run at a faster clip", "run_type": "Tempo Run"},
    {"date": "2024-08-19", "total_miles": 10, "run_details": "Easy run, focus on form", "run_type": "Easy Run"},
    {"date": "2024-08-20", "total_miles": 12, "run_details": "Hills with 5 repeats", "run_type": "Hills"},
    {"date": "2024-08-21", "total_miles": 4, "run_details": "Recovery run", "run_type": "Easy Run"},
    {"date": "2024-08-22", "total_miles": 18, "run_details": "Long run at a consistent pace", "run_type": "Long Run"},
    {"date": "2024-08-23", "total_miles": 0, "run_details": "Rest day", "run_type": "Rest Day"},
    {"date": "2024-08-24", "total_miles": 8, "run_details": "Easy run to keep legs fresh", "run_type": "Easy Run"},
    {"date": "2024-08-25", "total_miles": 9, "run_details": "Intervals: 6x800m with rest", "run_type": "Intervals"},
    {"date": "2024-08-26", "total_miles": 10, "run_details": "Easy run with short strides", "run_type": "Easy Run"},
    {"date": "2024-08-27", "total_miles": 12, "run_details": "Race pace segments during the run", "run_type": "Race Pace"},
    {"date": "2024-08-28", "total_miles": 4, "run_details": "Short, easy recovery run", "run_type": "Easy Run"},
    {"date": "2024-08-29", "total_miles": 20, "run_details": "Long run at marathon effort", "run_type": "Long Run"},
    {"date": "2024-08-30", "total_miles": 0, "run_details": "Rest day", "run_type": "Rest Day"},
    {"date": "2024-08-31", "total_miles": 6, "run_details": "Easy run", "run_type": "Easy Run"},
    {"date": "2024-09-01", "total_miles": 8, "run_details": "Tempo run, strong effort", "run_type": "Tempo Run"},
    {"date": "2024-09-02", "total_miles": 10, "run_details": "Easy run with gentle hills", "run_type": "Easy Run"},
    {"date": "2024-09-03", "total_miles": 12, "run_details": "Last intervals: 4x400m", "run_type": "Intervals"},
    {"date": "2024-09-04", "total_miles": 4, "run_details": "Recovery run to stay loose", "run_type": "Easy Run"},
    {"date": "2024-09-05", "total_miles": 12, "run_details": "Race pace segments during the run", "run_type": "Race Pace"},
    {"date": "2024-09-06", "total_miles": 10, "run_details": "Easy run with gentle hills", "run_type": "Easy Run"},
    {"date": "2024-09-07", "total_miles": 18, "run_details": "Long run, easy pace", "run_type": "Long Run"},
    {"date": "2024-09-08", "total_miles": 0, "run_details": "Rest day", "run_type": "Rest Day"},
    {"date": "2024-09-09", "total_miles": 4, "run_details": "Shakeout run before the race", "run_type": "Easy Run"},
    {"date": "2024-09-10", "total_miles": 26, "run_details": "Marathon race day", "run_type": "Long Run"}
]"""
